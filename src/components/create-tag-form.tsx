		...
		<form onSubmit={handleSubmit(createTag)} className="w-full space-y-6">
			<div className="space-y-2">
				...
				<input
					...
					id="name"
					type="text"
					className="border border-zinc-800 rounded-lg  px-3 py-2.5 bg-zinc-800/50 text-sm"
				/>
			...
			<div className="space-2">
				...
				<input
					...
					readOnly
					value={slug}
					className="border border-zinc-800 rounded-lg  px-3 py-2 bg-zinc-800/50 text-sm.5"
				/>
			</div>
